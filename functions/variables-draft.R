...
A generational cohort is defined as a group of individuals who are born in the same time period and thus share similar life experiences (Mannheim, 1972). Contemporary society consists of five generations: Generation Silent, Generation Boomer, Generation X, Generation Y and Generation Z. The Pew Research Centre (2019) argues that one way to operationalise generation cohort is by technological advancements and the evolution of how individuals connect and communicate with one another. The birth categories are: Generation Silent (1928-1945), Generation Baby Boomer (1946-1964), Generation X (1965-1980), Generation Y (1981-1996) and Generation Z (1997-2012). 

Pew Research Centre. (January 17, 2019). Defining generations: Where Millennials End and 
  Generation Z begins. Retrieved 01 October, 2021, from: https://www.pewresearch .org/fact-tank/2019/01/17/where-millennials-end-and-generation-z-begins/ 
...
##    "nz_dep2018",
    # see nzavs materials (include description here)
...
##  "religion_church2", # How many times did you attend a church or place of worship in the last month? (If no religious identification is reported values are imputed as zero)
...
The following are a single construct (forget the name)
...
## "env_environment_values"  (waves: )
 Value - Protecting the environment PROTECTING THE ENVIRONMENT (preserving nature)
...
#### Religious Identification (waves: )
...
#### Frequency of Church Attendence (waves: )
...
#### Spiritual Identification (waves: )
...
#### Frequency of Scripture Reading (waves: )
...
#### Perceived Discrimination -- Religion (waves: )
...
## Citations (place in a separate "references.bib" file)
