...
#'
#' A light, enhanced version of boilerplate_manage_measures that automatically
...
#' @examples
#' # List all measures
#' measures_db <- boilerplate_manage_measures2_enhanced(action = "list")
#'
#' # Add a new measure with automatic sorting
#' measures_db <- boilerplate_manage_measures2_enhanced(
#'   action = "add",
...
#' Enhanced Modify a Nested Measure in the Database with Auto-Sorting
#'
...
# Helper functions load_measures_db, save_measures_db, and get_measures_file_path remain the same
