...
report_text <- boilerplate_generate_text(
  ...
  global_vars = list(
    ...
    date = "2025-04-01",
    abstract = "This study examines the causal effects of political orientation on mental health.",
    introduction = "Political polarisation has increased in recent years...",
