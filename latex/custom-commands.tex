...
\draw [-latex, draw=red] (Y) to node[pos=0.5, above, draw=none, text = red] {\small bias}(YS);
...
\draw [-latex,  bend left=30, draw=red] (A) to node[pos=0.5, above,draw=none, text = red] {\small attenuated} (Y); (Y);
\end{tikzpicture}
}
\newcommand{\mediatorm}{
\begin{tikzpicture}
...
\draw [-latex, bend left = 40, draw = red] (A1) to node[pos=0.5, above, draw=none, text= red] {\small biased}(Y1);
\end{tikzpicture}
}
...
\draw [-latex, draw = red] (Y) to  node[pos=0.5, draw=none, above, text= red] {\small biased }(YS);
...
\draw [-latex, draw =black] (A) to (A1);
\draw [-latex, draw = red, bend left = 40] (U) to node[pos=0.5, sloped, above, draw=none, text = red]{\small Correlated measurement error}(Y1);
\draw [-latex, draw = black] (Y) to (Y1);
\end{tikzpicture}
}
...
\begin{tikzpicture}
\node [rectangle, draw=black] (S) at (-.3, 2.35) {S=$\{0,1\}$};
...
\draw [-latex, draw = red] (Y) to node[pos=0.5, above, draw=none, text = red]{\small biased ATE}(Y1);
...
\draw [-latex, draw= red, bend left = 30] (A) to  node [pos=0.5, above, draw=none, text = red] {\tiny biased indirect effect} (M);
...
\draw [-latex,  draw=red, bend right = 30 ] (L3) to node[pos=0.5, below, sloped, draw=none, text = red] {\small confounder $L_3 \to Y_5$}(Y5);
\draw [-latex,  draw=black] (A4) to (Y5);
\draw [-latex,  draw=red, bend left = 30] (A1) to node[pos=0.5, above, draw=none, text = red] {\small blocks $A_1 \to Y_5$}(Y5);
\end{tikzpicture}
}
\newcommand{\feedbackA}{
\begin{tikzpicture}
...
\draw [-latex, draw=black, bend left = 30] (L2) to node [pos=0.5, above, draw=none, text = black] {\tiny confounder $L_3 \to Y_5$}(Y4);
...
\draw [-latex, black, bend left = 20, draw=red] (A) to  node[pos=0.5, above, draw=none, text = red] {\small attenuated} (Y);
...
\draw [-latex, draw=black] (A) to node[pos=0.5, above,  draw=none, text = black] {\small target}(Y);
\draw [-latex, draw=red] (Y) to node[pos=0.5, above, draw=none, text = red] {\small biased}(YS);
\draw [-latex, draw=blue] (US) to (YS);
\draw [-latex] (L) to (A);
\draw [-latex,bend right=20, blue] (L) to (Y);
\end{tikzpicture}
