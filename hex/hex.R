...
# cosmo-inspired colours
background_colour <- "#e83e8c" # "#2780e3"  # cosmo primary blue
border_colour <- "#1f66b8"      # darker blue for border
text_colour <- "#2780e3"        # white text
plate_colour <- "#e9ecef"       # light grey for plate
engraved_text_colour <- "#2780e3" # pink for {{...}} brackets


# light version for flexibility
# background_colour <- "#f8f9fa"  # very light grey
# border_colour <- "#dee2e6"      # light grey border
# text_colour <- "#212529"        # dark text
# plate_colour <- "#adb5bd"       # medium grey plate
# engraved_text_colour <- "#495057" # dark grey engraving
...
metal_plate_plot <- ggplot() +
  ...
  geom_text(
    aes(x = 5, y = 5, label = "{{...}}"),
    family = "sans",
    size = 40, # <-- increase this number to make the text larger.
